...
class BookingTest {
    ...
    void talkback() {
        ...
        LocalDateTime noPeekDay = LocalDateTime.of(2022, 1, 20, 19, 0);
        LocalDateTime peekDay = LocalDateTime.of(2022, 1, 15, 19, 0);

        assertFalse(Booking.createBooking(noTalkbackShow, noPeekDay).hasTalkback());
        assertTrue(Booking.createBooking(talkbackShow, noPeekDay).hasTalkback());
        ...
        assertTrue(Booking.createPremiumBooking(talkbackShow, noPeekDay, premiumExtra).hasTalkback());
